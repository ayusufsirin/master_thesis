...
Matematiksel formulasyona geçmeden önce algoritmanın geliştirilmesi ile varılmak istenen noktayı analojik olarak balsa uçak kanadı modeli üzerinden anlatımı devam eden bölümlerde verilmiştir.
...
DMF çıktısından nihai yayınlanan derinlik haritasının elde edilmesine ilişkin kural, Dinamik Papoulis--Gerchberg (DPG) bağlamında Şekil~\ref{fig:dpg_publish_rule}'de gösterilmektedir. Bu adımda, özgün ZED geçersizlik maskesi yeniden uygulanarak, yalnızca güvenilir derinlik ölçümleri içeren $D_{\mathrm{PG}}(v,u)$ haritası üretilmektedir.

\begin{figure}[H]
    \centering
    \begin{adjustbox}{width=\textwidth * 9 / 12}
        \includegraphics{mermaid/dpg_publish_rule.png}
    \end{adjustbox}
    \caption{Dinamik Papoulis--Gerchberg (DPG) bağlamında DMF çıktısından nihai yayınlanan derinlik haritasının elde edilmesi. Bu aşamada özgün ZED geçersizlik maskesi yeniden uygulanarak yalnızca güvenilir derinlik ölçümlerini içeren $D_{\mathrm{PG}}(v,u)$ haritası üretilmektedir.}
    \label{fig:dpg_publish_rule}
\end{figure}

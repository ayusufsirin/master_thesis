...
\input{./Experiments/EvoMethodology}

\section{Veri Setleri}

\input{./Experiments/CitrusFarmExplain}
%\input{./Experiments/CitrusFarmExplain_EN}

%\input{./Experiments/Results}
\input{./Experiments/CitrusFarmResults}
%\input{./Experiments/CitrusFarmResults_EN}

\section{Deneysel Sonuçlar | SensorSuiteV2 Veri Seti}

...
Görsellerde görüldüğü üzere LiDAR verisine karşılık üretilen sentetik veri ^B satranç tahtası üzerinde ölçüm hassasiyeti çok yüksek ancak seyrek noktalardan oluşmaktadır. Benzer mantıkla stereo sentetik verisi ise yüksek çözünürlüklü ancak gürültülüdür.
...
Gaussian filtre, frekans alanında yumuşak bir geçiş sağladığından, yüksek frekans bileşenlerini kademeli olarak bastırmakta ve uzaysal alanda daha kararlı sonuçlar üretmektedir. Butterworth filtre ise geçiş bölgesinin eğimini kontrol edilebilir kılması sayesinde, brick-wall filtreden daha yumuşak, Gaussian filtreden ise daha seçici bir yapı sunmaktadır. Yapılan deneyler, her iki filtrenin de brick-wall filtreye kıyasla, özellikle spike oluşumlarını belirgin şekilde azalttığını göstermiştir.
...
Filtre tiplerinin karşılaştırmalı analizi hem sentetik hem de gerçek veri üzerinde gerçekleştirilmiştir. Sentetik veride, ideal koşullar altında tüm filtrelerin benzer yakınsama davranışı sergilediği görülürken, gerçek veri üzerinde belirgin farklar ortaya çıkmıştır. Brick-wall filtre, keskin frekans kesimi nedeniyle yüksek frekanslı hataları bastırmakta yetersiz kalmış ve PG çıktısında artefaktlara yol açmıştır. Gaussian filtre, sensörler arası uyumsuzlukları daha iyi tolere etmiş ancak zemin bölgelerinde aşırı yumuşamaya neden olmuştur. Butterworth filtre ise bu iki uç arasında bir denge sağlayarak, hem spike oluşumlarını azaltmış hem de genel geometrik bütünlüğü daha iyi korumuştur.
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{\textwidth}
        \centering
        \includegraphics[width=10cm]{./Figures/pg_filter_selection/variance_filtered.png}
        \caption{Brick-wall LPF ile elde edilen PG çıktısı (Kırmızı noktalar PG çıktısı)}
    ...
    \begin{subfigure}[t]{\textwidth}
        \centering
        \includegraphics[width=10cm]{./Figures/pg_filter_selection/citrus_gaussian_0.16_33.png}
        \caption{Gaussian LPF ile elde edilen PG çıktısı (Beyaz noktalar PG çıktısı)}

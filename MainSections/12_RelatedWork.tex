...
Öğrenme tabanlı olmayan stereo--LiDAR füzyonuna yönelik erken dönem çalışmalarda, LiDAR derinlik ölçümlerinin stereo disparite haritalarını iyileştirmek amacıyla geometrik bir yardımcı bilgi olarak kullanıldığı görülmektedir. Bu bağlamda Parks ve ark.\cite{parks2018fusion} ile Park ve ark.\cite{park2019stereolidar}, LiDAR verisini stereo eşleştirme sürecine doğrudan dâhil ederek, çoğunlukla maliyet hacminin yeniden ağırlıklandırılması veya yerel düzeltme mekanizmaları üzerinden disparite hatalarını azaltmayı hedefleyen yöntemler önermişlerdir. Söz konusu yaklaşımlar, özellikle düşük tekstürlü veya tekrarlayan desenler içeren sahnelerde stereo eşleştirmenin kararsızlaştığı bölgelerde iyileşme sağlamaktadır.

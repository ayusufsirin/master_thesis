\section{Depth Map Fitting} \label{sec:depth_map_fitting}
...
\subsection{Girdiler ve gösterim}
...
\subsection{LiDAR nokta bulutundan derinlik imgesine projeksiyon}
...
\subsection{ZED derinlik ön-işleme ve geçersiz maske}
...
\subsection{Örtüşme bölgesi (cropping) ve tutarlılık filtresi}
...
\subsection{Derinlik haritası oturtma (fitting) ve yeniden birleştirme}

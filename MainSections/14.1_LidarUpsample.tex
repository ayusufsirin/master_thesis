...
Aşağıdaki Şekil~\ref{fig:lu_overview}, LU düğümünün stereo yakınsama hattına girişten çıkışa kadar olan tüm işlem bloklarını üst düzeyde haritalayarak, dönüşüm ve birikim adımlarının mantıksal sıralamasını özetlemektedir.

\begin{figure}[H]
    \centering
    \begin{adjustbox}{width=\textwidth}
        \includegraphics{mermaid/lu_overview.png}
    \end{adjustbox}
    \caption{LiDAR nokta yoğunluğu artırımı (LU) akış şeması}
    \label{fig:lu_overview}
\end{figure}

\section{LiDAR Nokta Yoğunluğu Arttırımı} \label{lidar_upsample}
...
\subsection{Point cloud and odometry notation}
...
\subsection{Rigid-body transformation of the point cloud}
...
\subsection{Sliding-window cumulative point cloud}
...
\subsection{Timing and real-time metrics}
...
\subsubsection{Timestamps and latency}
...
\subsubsection{Input and processing rates}
...
\subsubsection{Queue occupancy and history size}
...
\subsubsection{Real-time condition}

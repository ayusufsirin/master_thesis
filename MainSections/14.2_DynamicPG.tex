\subsection{DİNAMİK PAPOULISH-GERCHBERG}  \label{sec:dynamic_pg}

\subsubsection{Mathematical Formulation of the Depth Fusion Pipeline}
...
\subsubsubsection*{Notation and Inputs}
...
\subsubsubsection*{LiDAR Cartesian to Spherical Representation}
...
\subsubsubsection*{LiDAR to Camera Projection and Depth Image}
...
\subsubsubsection*{ZED Depth Inpainting}
...
\subsubsubsection*{Cropping and ZED--LiDAR Consistency Filtering}
...
\subsubsubsection*{Final Fused Depth Map}
...
\subsubsubsection*{Back-Projection to 3D and Output Point Cloud}
...
\subsubsection{Sentetik Veri ile Algoritmanın Doğrulanması}
...
\subsubsection{3B İçin Filtre Seçimi}
...
\subsubsubsection{Cutoff Frekansını Ayarlama}
...
\subsubsubsection{Filtre Tipi Seçimi}
...
\subsubsubsection{Filtrelerin Çapraz Karşılaştırılması}

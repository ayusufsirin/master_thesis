\subsubsection{Deneysel Sonuçlar ve Matematiksel Modelin Doğrulanması}
...
\subsubsubsection{Performans Yüzeyi $M(I,H)$ ve Genel Eğilimler}
...
\subsubsubsection{PG İterasyonlarının Ana Etkisi ($\alpha(I)$)}
...
\subsubsubsection{LU Geçmiş Boyutunun Ana Etkisi ($\beta(H)$)}
...
\subsubsubsection{Etkileşim Terimi ve Süperpozisyon Varsayımı}
...
\subsubsubsection{Citrus Farm Veri Setinde Yönelim Bias’ının Düzeltilmesi}
...
\subsubsubsection{Teori ve Deneysel Bulguların Örtüşmesi}
